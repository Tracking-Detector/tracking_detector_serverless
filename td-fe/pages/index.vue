<template>
    <div>
        ...
        <v-card class="pa-4 mt-3">
            ...
            <v-divider></v-divider>
            <v-list>
                <v-list-item v-for="check of performedHealthChecks">
...
const downloadEndpoint = ref([
    ...
    },
    {
        ...
        method: 'GET',
        description: 'Downloads the raw files from the model. This can be used to load the model via tensorflow.'
    },
    {
...
const trainingRunsEndpoint = ref([
    {
        ...
        method: 'GET',
        description: 'Endpoint to check the health of the training-runs microservice.'
    },
    {
