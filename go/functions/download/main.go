...
func main() {
	...
	app.Get("/download/models", GetDownloadModels)
	app.Get("/download/models/:modelName/:zippedModelName", GetZippedModel)
	app.Get("/download/models/:modelName/:trainingSet/:filename", GetModelData)
	app.Listen(":8081")
}
